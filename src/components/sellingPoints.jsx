...
export default function sellingPoints() {
    return (
        <div className="sellingPoints">
           ...
           <h3> SAY HELLO FROM MEDITEX CENTER </h3>
            <h5><br/>Our doctors and staff at Meditex will provide the very best patient care possible and offer it in a timely manner.</h5>
            </div>
